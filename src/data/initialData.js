// Données de démonstration initiales pour TontineApp
// Utilisées en mode hors-ligne / fallback avant synchronisation avec Supabase

export const initialUsers = [
  { id: 1, username: 'admin', role: 'admin', nom: 'Administrateur Principal', avatar: '👨‍💼' },
  { id: 2, username: 'user1', role: 'user', nom: 'Jean Kamga', avatar: '👤' },
  { id: 3, username: 'user2', role: 'user', nom: 'Marie Fotso', avatar: '👩' },
  { id: 4, username: 'chinang', role: 'user', nom: 'Chinang Pariss', avatar: '👩' }
];
...
export const initialReglement = {
  ...
  articles: [
    ...
    },
    {
      ...
      contenu: "L'adhésion est ouverte à toute personne majeure après validation du comité. Chaque membre s'engage à verser une cotisation mensuelle dont le montant est fixé lors de l'adhésion. Le non-paiement de trois cotisations consécutives entraîne la suspension temporaire des droits du membre."
    },
    {
      numero: 3,
  ...
  signatures: [
    { role: 'Le Président', nom: 'M. TALLA Joseph', date: '2025-01-01' },
    { role: 'Le Trésorier', nom: 'Mme FOTSO Marie', date: '2025-01-01' },
    { role: 'Le Secrétaire', nom: 'M. KAMGA Jean', date: '2025-01-01' }
  ]
};
